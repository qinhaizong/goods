package com.wxhl.bookstore.book.web.servlet;
...
import com.wxhl.bookstore.book.domain.Book;
import com.wxhl.bookstore.book.service.BookService;
...
public class BookServlet extends BaseServlet {
	...
	private String getUrl(HttpServletRequest req) {
		String url = StringUtils.isBlank(req.getQueryString()) ? req.getRequestURI() + "?" : req.getRequestURI() + "?" + req.getQueryString();
	...
	public String findByCategory(HttpServletRequest request, HttpServletResponse response)
		...
		if (!url.contains("&method=findByCategory")) {
			url += "&method=findByCategory";
		}
		pb.setUrl(url);
		/*
