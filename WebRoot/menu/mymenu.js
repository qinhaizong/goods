...
Q6MenuBar.prototype.toString = function () {
    // menuBar对应的<div>
    var str = '<div class = "menuBar" name="menuBar" onClick="' + this.obj + '.showMenu(event, this)">\n';
    // menuBar的标题<div>
...
Q6MenuBar.prototype.menu2Str = function (menuName) {
    ...
    str += '<div name="menuTitle" class="menuTitle"><span name="menuTitleIcon" class="menuTitleIcon"><img src="' + icon + '"/></span><span class="menuTitleText">' + menuName + '</span></div>\n';
    // 菜单内容对象的<div>，所有菜单荐都存放在这个<div>中。
    str += '<div class="menuContent"  name="menuContent">\n';
...
Q6MenuBar.prototype.item2Str = function (menuItem) {
    return '<div class="menuItem" onClick="skip(\'' + menuItem.url + '\', \'' + menuItem.frameName + '\')">' + menuItem.menuItemName + '</div>\n';
};
